...
State the interfaces changed and the abstraction level for each decision.

## Separation of Concerns and Decomposition

Explain why the stage is cohesive and where further splitting is or is not useful.
...
Draft. Explain the next gate or action truthfully.
