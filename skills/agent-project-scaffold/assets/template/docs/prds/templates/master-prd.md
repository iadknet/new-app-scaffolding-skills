...
Describe relevant repository state, research, dependencies, and interactions.
...
Explain why the stages are independently coherent and dependency ordered.
...
Summarize ordering and cross-stage contracts without duplicating stage tasks.
