...
find bin tests skills/agent-project-scaffold/scripts skills/agent-project-scaffold/assets/template/scripts skills/agent-project-scaffold/assets/template/.githooks -type f -exec "$shellcheck" --shell=sh --external-sources {} +
